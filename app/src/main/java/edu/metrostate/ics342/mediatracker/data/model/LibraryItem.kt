...
object LibraryStatusSerializer : KSerializer<LibraryStatus> {
    ...
    override fun serialize(encoder: Encoder, value: LibraryStatus) = encoder.encodeString(value.toApiString())
    override fun deserialize(decoder: Decoder): LibraryStatus = LibraryStatus.fromString(decoder.decodeString())
}
